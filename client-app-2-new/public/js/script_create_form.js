...
myApp.controller('AdminController', ['$scope', '$window', '$http', function ($scope, $window, $http) {
    ...
    //$scope.subjects=[['Data Structure','Networking'],['DS','DBMS'],['Analog Electronics','Digital Electronics'],['Microbiology','Biocemical analysis & Instrumentation'],['Solid Mechanics','Fluid Mechanics'],['Thermodynamics','Mechanics'],['Solid Mechanics','Fluid'],['Iron Making','Materials Making'],['Machine Design','control systems']];
...
/*
 $scope.subjectSelectionDone = function (done) {
        if (done) {
            ...
            $scope.subjects[$window.i].forEach(function (subject) {
 ...
 $scope.Activate_Form = function() {
    ...
    $scope.submitForm = function () {
       ...
       //$scope.finalObject.targetedsub = $scope.selectedSubjects;
        ...
        $scope.finalObject.activate=$scope.activate;
